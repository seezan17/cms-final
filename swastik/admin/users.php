  ...
  <h2>Users</h2>
                ...
                <table id="table-data">
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="post">
                            <a href="manage/edit.php?a=user_fullname,user_email,user_permission,user_faculty,user_semester,user_code,isactive&b=swastik_users&c=user_id&d=<?php echo $user['user_id'] ?>" style="color:green;">Edit</a> 
                            <a onclick="return confirm('Are you sure this user is not active anymore?') " href="user/notactive.php?id=<?php echo $user['user_id'] ?>" style="color:red" class="right">Close</a>
                        </form>
                        </td>
                      </tr>
