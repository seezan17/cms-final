...
$conn = mysqli_connect("localhost","swastik","","cms_swastik") or die("Connection Failed");
              ...
              <thead>
                ...
                <td> {$row["user_code"]}</td><td>
                 {$row["isactive"]}</td><td>
                            ...
                            <a onclick='return confirm('Are you sure this user is not active anymore?') ' href='user/notactive.php?id={$row["user_id"]}'' style='color:red' class='right'>Close</a>
                        </form>
                        </td></tr>";
              }
